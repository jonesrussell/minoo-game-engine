...
Issue140: named opening/closing conversations and a transient controller are implemented. K01 live award opens the approved three-line closing once; final Next/Skip enters the receipt. Pause/receipt history unlocks from restored K01 state without persisting dialogue indices or changing action journals. O1-O4 findings remain in search with HUD feedback; O5/O6 preserve inspection panels.

#140 integration: tightened history focus return and Escape callback cleanup; moved conversation titles and brief/inspect discovery decisions into canonical presentation data. Initial production browser check caught history Back focusing Resume; fixed to restore History. Full final qualification pending in PR evidence.
